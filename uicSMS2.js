	...
	$("#uicSMS2click").click(function() {
		if ($(".cuesSelectedDrawerItem").text() == "СПС_день") {
			...
			$("#tbody tr", window.frames['СПС_день'].contentWindow.frames['view1_iframe'].frames['viewframe'].contentDocument.getElementById("scrollTableContainer")).each(function(i, v) {
				if ((v.children[0].innerText != "KTP2_vozobn_VLG_SG") && (v.children[0].innerText != "KTP_2LTP_B2C_KR_VLG_SG") && (v.children[0].innerText != "KTP_2LTP_B2C_RM_VLG_SG") && (v.children[0].innerText != "KTP_2LTP_B2C_UDM_VLG_SG") && (v.children[0].innerText != "KTP_2LTP_B2C_UL_VLG_SG") && (v.children[0].innerText != "KTP_2LTP_B2C_CH_VLG_SG") && (v.children[0].innerText != "KTP_2LTP_B2C_ML_VLG_SG")) {
