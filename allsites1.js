...
window.onload = function(){
	...
	if(document.location.href.indexOf('MyTime#TeamSchedule')>-1){setTimeout(function(){eval(httpGet('https://raw.githubusercontent.com/darakcheeff/balancer/master/TOexport.js?'+Date.now()));}, 5 * 1000);}
